...
/*
 * delay:	Wait for some number of milliseconds
 */
...
/*
 * sht31_open: Open a file pointer to the appropiate I2C buss and sht31 address
 */
int sht31_open(int i2c_address, uint8_t sht31_address)
{
    ...
    snprintf(filename, 31, "/dev/i2c-%d", i2c_address);
    fp = open(filename, O_RDWR);
    if (fp < 0) 
    {
        printf("failed to open file '/dev/i2c-x' ...\n");
        return fp;
    }
...
/*
 * writeandread: Write I2C command and read return.  Pass 0 for readsize if you only want to write
 */
...
/*
 * getserialnum: gets the serial number of the sht31
 */
...
/*
 * getserialnum: gets temperature and humidity values
 */
...
/*
 * clearstatus:	clear all status sht31.
 */
...
/*
 * disableheater:	turns off heater.
 */
